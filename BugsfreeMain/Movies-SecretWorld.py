...
class M3UCollector:
    def __init__(self, country="SecretWorld", base_dir="Movies"):
...
def main():
    ...
    collector = M3UCollector(country="SecretWorld")
    ...
    logging.info(f"[{mumbai_time}] Collected {total_channels} active, unique channels for SecretWorld")
