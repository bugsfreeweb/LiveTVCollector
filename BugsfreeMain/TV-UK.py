...
class M3UCollector:
    def __init__(self, country="UK", base_dir="LiveTV", check_links=True):
...
def main():
    ...
    collector = M3UCollector(country="UK", check_links=False)
    ...
    logging.info(f"[{mumbai_time}] Collected {total_channels} unique channel for UK")
